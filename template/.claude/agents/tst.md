...
3. **Run tests, don't assume** – actually execute the test suite; check results
4. **Create BUG items for failures** – document reproduction steps, expected vs. actual behavior
5. **Check regressions** – verify that adjacent features still work after the change
