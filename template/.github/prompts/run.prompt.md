---
description: 'Auto-pilot: executes APPROVED items end-to-end (start → implement → test → fix → done). Stops only on escalation.'
name: 'Run auto-pilot'
argument-hint: 'Optional item IDs. Leave empty for all APPROVED items.'
agent: 'agent'
---
<!-- GENERATED FILE — do not edit directly.
     Source:   .claude/commands/run.md
